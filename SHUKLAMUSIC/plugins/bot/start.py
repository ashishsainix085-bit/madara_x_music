...
YUMI_PICS = [
"https://i.ibb.co/bRr9nN7L/x.jpg",
"https://i.ibb.co/0yhfy3h3/x.jpg",
"https://i.ibb.co/v6C6q6WG/x.jpg",  
...
async def start_pm(client, message: Message, _):
    ...
    await loading_1.edit_text("<b>ᴅɪηɢ ᴅᴏηɢ...❤️‍🔥</b>")
    await asyncio.sleep(0.1)
    await loading_1.edit_text("<b>𝐀ʀꜱᴇᴇɴᴀ</b>")
    await asyncio.sleep(0.1)
    await loading_1.edit_text("<b>𝐀ʀꜱᴇᴇɴᴀ ꭙ</b>")
    await asyncio.sleep(0.1)
    await loading_1.edit_text("<b>𝐀ʀꜱᴇᴇɴᴀ ꭙ ϻᴜsɪᴄ ♪</b>")
    await asyncio.sleep(0.1)
